...
//     left_shipdate: Column<Advice>,
//     right_shipdate: Column<Advice>,

//     l_quantity: Column<Advice>,
//     right_quantity: Column<Advice>,

//     pub instance: Column<Instance>,

//     lt_left_discount: LtConfig<F, 2>,
//     lt_right_discount: LtConfig<F, 2>,
//     lt_left_shipdate: LtConfig<F, 2>,
//     lt_right_shipdate: LtConfig<F, 2>,
//     lt_quantity: LtConfig<F, 2>,
// }
...
//         let left_shipdate = meta.advice_column();
//         let right_shipdate = meta.advice_column();

//         let l_quantity = meta.advice_column();
//         let right_quantity = meta.advice_column();
...
//         let lt_left_shipdate = LtChip::configure(
//             meta,
//             |meta| meta.query_selector(q_enable),
//             |meta| meta.query_advice(left_shipdate, Rotation::cur()),
//             |meta| meta.query_advice(l_shipdate, Rotation::cur()), // we put the left and right value at the first two positions of value_l
//         );
