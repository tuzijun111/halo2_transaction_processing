...
//                 let mut o_combined: Vec<Vec<_>> = o_combined
//                     .clone()
//                     .into_iter()
//                     .filter(|row| row[0] >= condition[1] && row[0] < condition[2]) // r_name = ':3'
//                     .collect();

//                 let mut r_combined: Vec<Vec<_>> = r_combined
//                     .clone()
//                     .into_iter()
...
//                     let idx = if i % 2 == 0 { index[i / 2].2 } else { index[i / 2].3 };
...
//                 // join is used for permutation here
